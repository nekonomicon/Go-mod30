...
cvar_t	allow_noclip={"allow_noclip","1", FCVAR_SERVER };
...
cvar_t	precache_all_npcs={"precache_all_npcs","1",FCVAR_SERVER};

cvar_t	allow_camera	= {"allow_camera","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_bigmonsters	= {"allow_bigmonsters","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_monsterspawn	= {"allow_monsterspawn","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_weaponspawn	= {"allow_weaponspawn","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_props	= {"allow_props","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_toolgun	= {"allow_toolgun","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_bspmove	= {"allow_bspmove","0", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	allow_voices	= {"allow_voices","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	fakecoop	= {"fakecoop","1", FCVAR_SERVER};// CVAR FOR ALLY NPCS

cvar_t	mp_strip_weapons = {"mp_strip_weapons","0", FCVAR_SERVER};// CVAR FOR ALLY NPCS
...
// Crowbar whack
cvar_t	sk_plr_photocam1 = {"sk_plr_photocam1","0"};
cvar_t	sk_plr_photocam2 = {"sk_plr_photocam2","0"};
cvar_t	sk_plr_photocam3 = {"sk_plr_photocam3","0"};
...
void GameDLLInit( void )
{
	...
	CVAR_REGISTER (&allow_bigmonsters);
	CVAR_REGISTER (&allow_monsterspawn);
	CVAR_REGISTER (&allow_props);
	CVAR_REGISTER (&allow_weaponspawn);
	CVAR_REGISTER (&allow_toolgun);
	CVAR_REGISTER (&allow_bspmove);
	CVAR_REGISTER (&allow_voices);
	CVAR_REGISTER (&allow_noclip);

	CVAR_REGISTER (&fakecoop);
	...
	CVAR_REGISTER (&mp_strip_weapons);

	CVAR_REGISTER (&precache_all_npcs);
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER ( &sk_plr_photocam1 );// {"sk_plr_crowbar1","0"};
	CVAR_REGISTER ( &sk_plr_photocam2 );// {"sk_plr_crowbar2","0"};
	CVAR_REGISTER ( &sk_plr_photocam3 );// {"sk_plr_crowbar3","0"};
