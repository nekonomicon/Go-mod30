...
// sounds used from C physics code
	...
	PRECACHE_SOUND ("player/1997jumpon1.wav");
	PRECACHE_SOUND ("player/1997jumpon2.wav");

	PRECACHE_SOUND ("voice/female_fire_death.wav");
	PRECACHE_SOUND ("voice/fire_death_scream.wav");
	PRECACHE_SOUND ("voice/gogogo.wav");
	PRECACHE_SOUND ("voice/hey.wav");
	PRECACHE_SOUND ("voice/target_located.wav");
	PRECACHE_SOUND ("voice/there_he_is.wav");
	PRECACHE_SOUND ("voice/what_the.wav");
	PRECACHE_SOUND ("voice/yo.wav");
//
