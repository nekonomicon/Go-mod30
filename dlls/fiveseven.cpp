...
BOOL CFIVESEVEN::Deploy( )
{
	...
	return DefaultDeploy( "models/v_fiveseven.mdl", "models/p_fiveseven.mdl", FIVESEVEN_DRAW, "onehanded", UseDecrement(), pev->body );
...
{
	DefaultReload( 20, FIVESEVEN_RELOAD, 2.8);
}
