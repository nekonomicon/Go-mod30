...
CBaseEntity * CBaseEntity::Create( char *szName, const Vector &vecOrigin, const Vector &vecAngles, edict_t *pentOwner,CBasePlayer* Owner )
{
	edict_t	*pent;
	CBaseEntity *pEntity;
...
//	pEntity->pev->angles = vecAngles;
	if(STRING(pEntity->pev->classname) != "monster_camera")
	{
	...
	{
	//	pEntity->pev->angles.y = vecAngles.y;
	//	pEntity->pev->angles.x = vecAngles.x;
	//	pEntity->pev->angles.z = vecAngles.z;
		pEntity->pev->angles = vecAngles;
		camera_owner = Owner;
	}
