...
void EV_FireGRAPPLE( struct event_args_s *args ); //GRAPPLE
...
//	viewangles[PITCH] -= 0.7;
	...
	{
	case 0:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/p2282_fire1.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM );
		break;
	case 1:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/p2282_fire2.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM );
		break;
	}
...
enum photocam_e {
	...
	PHOTOCAM_HOLSTER,
	PHOTOCAM_ATTACK1HIT,
	PHOTOCAM_ATTACK1MISS,
	PHOTOCAM_ATTACK2MISS,
	PHOTOCAM_ATTACK2HIT,
	PHOTOCAM_ATTACK3MISS,
	PHOTOCAM_ATTACK3HIT
};
...
//Only predict the miss sounds, hit sounds are still played 
//server side, so players don't get the wrong idea.
void EV_Photocam( event_args_t *args )
{
...
//	viewangles[PITCH] -= 1;
	...
	if ( EV_IsLocal( idx ) )
	{
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( GRAPPLE_FIRE + gEngfuncs.pfnRandomLong(0,2), 2 );
