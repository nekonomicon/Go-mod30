...
CWeaponsMenu :: CWeaponsMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall) : CMenuPanel(iTrans, iRemoveMe, x,y,wide,tall)
{
    ...
    m_pPanel = new CTransparentPanel( 200, 80, 40, 416, 407);
	...
	//Imagen 9mmhandgun
    m_pMyPicture = new CImageLabel( "handgun", 1+lado, 90 );
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen 9mmhandgun

		 // Boton - 9mmhandgun Start
    m_pSpeak = new CommandButton( "", 3+lado, 92, 60, 60);
	...
	// Boton - 9mmAR Start
    m_pSpeak = new CommandButton( "", 87+lado+10, 92, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - Shotgun Start
    m_pSpeak = new CommandButton( "", 171+lado+30, 92, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - Gauss Start
    m_pSpeak = new CommandButton( "", 254+lado+50, 92, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - Grenade Start
    m_pSpeak = new CommandButton( "", 338+lado+70, 92, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - crowbar Start
    m_pSpeak = new CommandButton( "", 338+lado+70, 125+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    ...
    m_pMyPicture = new CImageLabel( "egon", 1+lado, 123+alto );
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen Egon

		// Boton - Egon Start
    m_pSpeak = new CommandButton( "", 3+lado, 125+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - satchel Start
    m_pSpeak = new CommandButton( "", 87+lado+10, 125+alto , 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - Rpg Start
    m_pSpeak = new CommandButton( "", 171+lado+30, 125+alto , 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - 357 Start
    m_pSpeak = new CommandButton( "", 254+lado+50, 125+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    ...
    // End - 357
		...
		//Imagen RemoveTool
    m_pMyPicture = new CImageLabel( "removetool", 1+lado, 213+alto );
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen RemoveTool

		 // Boton - RemoveTool Start
    m_pSpeak = new CommandButton( "", 3+lado, 215+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    ...
    m_pSpeak = new CommandButton( "", 87+lado+10, 215+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Boton - Physgun Start
    m_pSpeak = new CommandButton( "", 170+lado+30, 215+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    ...
    // End - Physgun
		...
		// Imagen Snark
    m_pMyPicture = new CImageLabel( "snark", 252+lado+50,213+alto );
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen Snark

	// Boton - Snark Start
    m_pSpeak = new CommandButton( "", 252+lado+50, 215+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    m_pSpeak->addActionSignal( new CMenuHandler_StringCommand( "snark" ) );
    // End - Snark
	...
	///////////    START TERCERA  FILA \\\\\\\\\\\\\\\\\\\\
		...
		// Imagen Tripmine
    m_pMyPicture = new CImageLabel( "tripmine", 338+lado+70, 213+alto );
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen Tripmine

		// Boton - Tripmine Start
    m_pSpeak = new CommandButton( "",338+lado+70, 215+alto, 60, 60);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
    m_pSpeak->addActionSignal( new CMenuHandler_StringCommand( "tripmine" ) );
    // End - Tripmine
