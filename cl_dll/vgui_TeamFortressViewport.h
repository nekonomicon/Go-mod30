...
private:
	...
	Label               *m_pTitle; 
	CommandButton       *m_pSpeak; 
	CommandButton       *m_pHLWeapon; // HL WEAPON MENU
	CommandButton       *m_pHLNpcs; // HL MONSTER MENU
	CommandButton       *m_pHLProps; // HL PROP MENU


    TextEntry           *m_pEditbox;
    CImageLabel         *m_pMyPicture;
	CImageLabel         *m_pHLWeaponImage;
	CImageLabel         *m_pHLNpcsImage;
	CImageLabel         *m_pHLPropsImage;
